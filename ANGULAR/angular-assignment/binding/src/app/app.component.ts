...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet,AccountHolderComponent,RouterLink,HomeComponent,ContactComponent,CustomdirectivesDirective,CommonModule,ShirtSizeComponent,SizePipe],
